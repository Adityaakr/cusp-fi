...
const Index = () => {
  ...
  const { data: markets = [], isPending: marketsPending } = useDflowMarkets({
    status: "active",
    limit: 50,
  });
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-8 max-w-lg">
                Borrow, lend, and leverage your Kalshi positions on Solana. Built on DFlow, secured by regulated event markets — no token, no emissions, real credit.
              </p>
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          {waitlistCount !== null && (
            <p className="text-xs text-muted-foreground mb-2">
              <span className="font-mono text-cusp-teal font-semibold">{(waitlistCount + 250).toLocaleString()}</span> people on the waitlist
            </p>
          )}
