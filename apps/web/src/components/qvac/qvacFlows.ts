...
export const QVAC_FLOWS: QvacFlow[] = [
  {
    ...
    description: "Supply USDC and earn yield",
    ...
    buildCommand: (values, wallet) => ({
      ...
      user_wallet: wallet,
      input_accounting_asset: "USDC" as Asset,
      underlying_asset: "USDC" as Asset,
      execution_asset: "USDC" as const,
  ...
  },
  {
    ...
    description: "Burn cUSDT and receive USDC",
  ...
  },
  {
    ...
    steps: [
      {
        ...
        type: "select",
        options: [
          { label: "USDC", value: "USDC", description: "Use USDC as collateral" },
    ...
    buildCommand: (values, wallet) => ({
      intent_id: crypto.randomUUID(),
      user_wallet: wallet,
      input_accounting_asset: (values.collateral_asset as Asset) || "USDC",
      underlying_asset: "USDC" as Asset,
      execution_asset: "USDC" as const,
      amount_ui: values.amount_ui as number,
      requires_user_confirmation: true,
      ...
      collateral_asset: (values.collateral_asset as Asset) || "USDC",
      borrow_asset: (values.borrow_asset as Asset) || "USDC",
  ...
  },
  {
    ...
    buildCommand: (values, wallet) => ({
      intent_id: crypto.randomUUID(),
      user_wallet: wallet,
      input_accounting_asset: (values.repay_asset as Asset) || "USDC",
      underlying_asset: "USDC" as Asset,
      execution_asset: "USDC" as const,
      amount_ui: values.amount_ui as number,
      requires_user_confirmation: true,
      ...
      repay_asset: (values.repay_asset as Asset) || "USDC",
