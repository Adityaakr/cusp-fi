...
export const faqItems = [
  { q: "What is Cusp?", a: "CUSP is building the capital layer for prediction markets on Solana. Prediction markets are emerging as a new financial primitive, but capital inside them remains largely idle after a trade. CUSP unlocks that capital through stablecoin vaults, yield routing, borrow/lend surfaces, and risk-aware capital management, turning outcome-market exposure into productive financial assets for collateral, yield, credit, leverage, and structured capital products." },
