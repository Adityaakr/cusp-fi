...
export const faqItems = [
  { q: "What is Cusp?", a: "Cusp is the DeFi capital layer for prediction markets on Solana. Our first product is a protocol for borrowing against, lending to, and leveraging Kalshi positions. Over time we will expand to more markets and financial primitives across the prediction-market stack." },
  { q: "How does it work?", a: "On Kalshi, every share you buy is a claim that settles to $1 if you are right. DFlow tokenizes those YES/NO outcomes as SPL tokens on Solana. Cusp lets you transfer and deposit these tokens into our pools to borrow USDC against them, or deposit USDC directly to earn yield from those same borrowers." },
  ...
  { q: "Who uses it?", a: "Traders use Cusp to maximize capital efficiency on their Kalshi positions — borrowing USDC without selling, looping into 2x leverage, or earning passive yield by lending into the same pools. Advanced users and funds use it as a financial primitive on top of regulated event markets." },
